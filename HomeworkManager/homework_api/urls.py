...
from . import views
from .views import deleteAssignment, createAssignment, updateAssignment, timeAssignment, deleteTimer, timeManagement, timeManagement2, averageManagement

urlpatterns = [
    path('', views.IndexView.as_view(), name='index'),
    path('timemanagement', views.timeManagement.as_view(), name='timeManagement'),
    path('averagemanagement', views.averageManagement.as_view(), name='averageManagement'),
